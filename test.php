...
require_once '/var/www/lottery-master/Lottery.php';
...
$lottery = PhpZendo\Lottery::make($config = array("indexField" => 'pid', "weightField" => "weights", "debug" => true));

$result = array();

$i = 0;
while ( $i < 100) {
	$prize = $lottery->go($settings);
